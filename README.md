...
- Brand Foundation：Brand DNA、Brand Positioning、Mission & Vision 派生说明与 Brand Values 已获批准；正式 Brand Values 只有八项，第七项为“技术辅助，人来决定”，Values Decision Rule 不是第九项价值观。母品牌面向未来公众，当前 Health 处于创始人私人真实验证阶段；其余品牌文件仍为 `proposed`，下一审核对象为 Brand Personality，见 [brand/README.md](brand/README.md)。
