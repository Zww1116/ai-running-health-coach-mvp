...
- Brand Foundation：Brand DNA、Brand Positioning、Mission & Vision 派生说明、Brand Values、Brand Personality 与 Brand Voice 已获批准；Brand Voice 是专业、冷静、有温度、诚实、克制的母品牌通用表达系统，事实、判断与建议应尽量分开，不制造 AI 依赖。母品牌面向未来公众，当前 Health 处于创始人私人真实验证阶段；其余品牌文件仍为 `proposed`，下一审核对象为 Product Principles，见 [brand/README.md](brand/README.md)。
