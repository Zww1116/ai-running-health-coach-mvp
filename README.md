...
- Brand Foundation：Brand DNA、Brand Positioning、Mission & Vision 派生说明、Brand Values 与 Brand Personality 已获批准；品牌关系原型为“可信赖的长期伙伴”，尊重与诚实是人格表达底线，陪伴不能制造依赖，克制不能回避安全风险。母品牌面向未来公众，当前 Health 处于创始人私人真实验证阶段；其余品牌文件仍为 `proposed`，下一审核对象为 Brand Voice，见 [brand/README.md](brand/README.md)。
